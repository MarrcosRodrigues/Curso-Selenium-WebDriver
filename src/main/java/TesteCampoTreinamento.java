...
//		driver.quit();
	...
	public void testeTextFieldDuplo() {
		dsl.escrever("elementosForm:nome", "Marcos");
		Assert.assertEquals("Marcos", dsl.obterValorCampo("elementosForm:nome"));
...
//		js.executeScript("alert('Testando js via selenium')");
	...
	public void deveClicarBotaoTabela() {
		dsl.clicarBotaoTabela("Escolaridade", "Superior", "Radio", "elementosForm:tableUsuarios");
	}
}
